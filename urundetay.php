		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 product-details">
					<h2 class="p-title"><?php echo $products['productName']?></h2>
					<h3 class="p-price"><?php echo number_format($products['productsPrice'],2,",","."). "TL" ?></h3>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="footer-widget about-widget">
						...
						<ul>
							...
							<li><a href="">Siparişlerini Takip Et</a></li>
						...
						<div class="fw-latest-post-widget">
							<div class="lp-item">
								...
								<div class="lp-content">
									<h6>Ne Almalıyım?</h6>
									<span>Eylül 15,2021</span>
									<a href="#" class="readmore">Daha Fazla Bilgi Al</a>
								</div>
							</div>
							<div class="lp-item">
								<div class="lp-thumb set-bg" data-setbg="img/blog-thumbs/2.jpg"></div>
								<div class="lp-content">
									<h6>Bu senenin trendleri!</h6>
									<span>Eylül 15,2021</span>
									<a href="#" class="readmore">Daha Fazla Bilgi Al</a>
								</div>
							</div>
